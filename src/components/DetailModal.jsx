...
export default function DetailModal({ client, contactLogs, onSave, onDelete, onLogContact, onClose, saving }) {
  ...
  async function handleLog() {
    ...
    await onLogContact(client.id, logMethod, logNote.trim())
    setLogNote('')
        ...
        <div className="detail-grid">
          ...
          <div className="detail-fields">
            ...
            <div className="field">
              ...
              <input value={form.next_action || ''} onChange={e => set('next_action', e.target.value)} placeholder="Specific next step" />
            </div>
            <div className="field">
            ...
            <div className="field">
              <textarea value={form.notes || ''} onChange={e => set('notes', e.target.value)} placeholder="Context, observations, anything relevant..." />
            </div>
          </div>
          ...
          <div className="detail-history">
            <div className="history-header">
              ...
              <button className="btn btn-sm btn-secondary" onClick={() => setShowLogForm(!showLogForm)}>
                + Log
              </button>
            </div>
            ...
            {showLogForm && (
              <div className="log-form">
                <select value={logMethod} onChange={e => setLogMethod(e.target.value)} className="log-method">
